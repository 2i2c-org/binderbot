...
```bash
clinder start https://mybinder.org/ --github-repo binder-examples/requirements
```
...
The [GitHub Action](./github-action.md) exports both variables for the rest of the workflow automatically. The [Clinder CLI](./cli.md) lets you export these variables yourself.
...
Clinder is currently maintained by [2i2c](https://2i2c.org), with support from [Project Pythia](https://2i2c.org/collaborators/pythia). Our intent is upstream this project and build a broader community around it.
